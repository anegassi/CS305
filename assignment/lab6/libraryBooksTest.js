...
const myExports = require("./app2.js");  //with node need the name of your file with your functions here
...
const findAuthors=myExports.findAuthor;
console.log("myExports ",myExports);
