...
const myMap1 = imports.myMap1;
const myMap2 = imports.myMap2;
const triple = imports.triple;
...
describe("times100", function () {
    ...
    describe("myMap", function () {
        ...
        it("tests myMap on triples anonymous function", function () {
            assert.deepStrictEqual(myMap1(testArray ,triple), [-30, 0, 30, 60]);
        });
        it("tests myMap on triples arrow function", function () {
            assert.deepStrictEqual(myMap2(testArray, triple), [-30, 0, 30, 60]);
        });
    });